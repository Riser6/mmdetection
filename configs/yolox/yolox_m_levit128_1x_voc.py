...
LeViT_128 = {
    ...
    'pretrained': True, 'weights': 'https://dl.fbaipublicfiles.com/LeViT/LeViT-128-b88c2750.pth'
}

model = dict(
    type='YOLOX',
    backbone=dict(type='LeViTWrapper', **LeViT_128),
    neck=dict(
        type='YOLOXPAFPN',
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(224, 224), override=True),  #
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Resize', img_scale=(224, 224), override=True),  #
            dict(type='Pad', size=(224, 224), pad_val=114.0),
            dict(type='Normalize', **img_norm_cfg),
            dict(type='DefaultFormatBundle'),
