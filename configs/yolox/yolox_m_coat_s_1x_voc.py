...
model = dict(
    type='YOLOX',
    backbone=dict(type='CoaT', patch_size=4, embed_dims=[152, 320, 320, 320], serial_depths=[2, 2, 2, 2],
                  parallel_depth=6, num_heads=8, mlp_ratios=[4, 4, 4, 4], return_interm_layers=True,
                  out_features=["x2_nocls", "x3_nocls", "x4_nocls"],
                  pretrained='https://vcl.ucsd.edu/coat/pretrained/coat_small_7479cf9b.pth'),
    # neck=dict(
    #     type='YOLOXPAFPN',
