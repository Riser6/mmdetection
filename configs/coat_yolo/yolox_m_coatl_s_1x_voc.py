...
model = dict(
    type='YOLOX',
    backbone=dict(type='CoaT', patch_size=4, embed_dims=[64, 128, 320, 512], serial_depths=[3, 4, 6, 3],
                  parallel_depth=0, num_heads=8, mlp_ratios=[8, 8, 4, 4], return_interm_layers=True,
                  out_features=["x2_nocls", "x3_nocls", "x4_nocls"],
                  pretrained='https://vcl.ucsd.edu/coat/pretrained/coat_lite_small_8d362f48.pth'),
    neck=dict(
        type='YOLOXPAFPN',
